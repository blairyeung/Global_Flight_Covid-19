...
public class Data {
    private double datapack[] = new double[11];
    ...
    public Data(String name, double data[], ArrayList[][] ArrayPackInt, ArrayList[][] ArrayPackDouble, double R, double AgeMatrix[],double[] AgePopulationStratification, ArrayList<Integer> A){
        this.NGMT = A;
        int sum = 0;
        for (int i = 0; i < 16; i++) {
