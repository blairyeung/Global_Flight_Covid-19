...
public class PrintResult{
    ...
    public void PRINTOUT(){
        ...
        String toPrint[] = {"Infected","Exposed","Active Cases","Resolved","Death","Immuned","Importation","Exportation"};
        String firstline = "";
        String firstline2 = "";
        String firstline3 = "";
        String firstline4 = "";
        ...
        File fileIm = new File(Parameters.PathDefault+"Output/Importation Trail "+ Main.ini +" "+Main.Filecode+".csv");
        File fileEp = new File(Parameters.PathDefault+"Output/Exportation Trail "+ Main.ini +" "+Main.Filecode+".csv");
        //File P = new File(Parameters.PathDefault+"Patient Track/Patient Report "+ Main.ini +" "+Main.Filecode+".csv");
        //File filebycountry = new File(Parameters.PathDefault+"Global Flight/Countrytest Trail "+ Main.ini +" "+Main.Filecode+".csv");
        try {
            ...
            for (int i1 = 0; i1 < Main.NAMING.length; i1++) {
                for (int i2 = 0; i2 < Main.NAMING[i1].length; i2++) {
                    if(Globe.NAMING[i1][i2]!=null){
                        ...
                        buffer3 = Double.toString(Globe.counties[i1][i2].getPrintPack()[i][9]);
                        buffer4 = Double.toString(Globe.counties[i1][i2].getPrintPack()[i][10]);
