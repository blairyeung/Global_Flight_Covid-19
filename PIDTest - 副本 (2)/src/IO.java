    ...
    public class IO extends Flight{
        ...
        public IO(){
            File file = new File(Parameters.PathDefault+"FlightCity/WPP2019_TotalPopulationBySex.csv");
            File Codefile = new File(Parameters.PathDefault+"FlightCity/CCode.csv");
            File EVENT = new File(Parameters.PathDefault+"FlightCity/Countrycode.csv");
            File fileR0 = new File(Parameters.PathDefault+"FlightCity/R File.csv");
            Scanner scan = null;
            ...
            for (int i = 0; i < SocialMix.length; i++) {
                ...
                String name = Parameters.PathDefault+"Social Mixing 16/"+Countrycode.get(i)+Suf;
           ...
           /* File outputBias = new File(Parameters.PathDefault+"Bias.csv");
            PrintWriter printer = null;
            try {
                printer = new PrintWriter(outputBias);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
            for (int i = 0; i < 250; i++) {
