...
public class Transmission extends County{
    ...
    public Data Model(Data data){
        ...
        System.out.println("Day: " + day +"    Population: " + population +"    Infected: " + infected + "    cases: " +activecases +"    Exposed:"+exposed +"    Recovered:" +Resolved +"    Death:" +death +"    R0:" + R0);
        day++;
        datapack[0] = day;
    ...
    public static int Contact(double lockdown, double random, String name, int Age, double[] AgeMatrix) {
        ...
        int contact = ((int) (2*(4.0+random+0.3*poss)*6*(lockdown)/2.79));
        int Ageind = -1;
        int list[] = {1,2,3,45,70};
