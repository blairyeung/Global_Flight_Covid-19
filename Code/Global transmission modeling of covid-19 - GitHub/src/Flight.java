...
public class Flight {
    ...
    public Flight(){
        File Flightfile = new File("E:/Global Model/FlightCity/Path4.csv");//PATH2
        File Cityfile = new File("E:/Global Model/FlightCity/AIR.csv");
        Scanner scan = null;
        try {
        ...
        /*for (int i = 0; i < Flightlist.size(); i++) {
            System.out.println(Flightlist.get(i).getDepart());
            if(IATACode.contains(Flightlist.get(i).getDepart())){
                Flights[Flightlist.get(i).getYear()-2019][Flightlist.get(i).getMonth()-1][Flightlist.get(i).getDay()-1][IATACode.indexOf(Flightlist.get(i).getDepart())] = new ArrayList();
            }
        }*/
        ...
        for (int i = 0; i < Flightlist.size(); i++) {
            /*System.out.println(Flightlist.get(i).getYear());
            System.out.println(Flightlist.get(i).getMonth());
            System.out.println(Flightlist.get(i).getDay());*/
