...
public class Main {
    ...
    final static public int ObservationRange = Constant.ObservationRange;
    ...
    public  static void main(String[] args) {
        ...
        /*for (int i1 = 0; i1 < CountyinCountry[IO.Countrycode.indexOf("CN")].size(); i1++) {
            int country = IO.Countrycode.indexOf("CN");
            String countyini = CountyinCountry[country].get(i1);
            ini = countyini;//ORIGIN
            for (int i = 0; i < 3; i++) {
                PopulatoinS();
                Filecode = out.ReadFile();
                Globe world = new Globe();
    ...
    /*public Main(){
        ...
        //FlightSearch();
        //FlightToCounty();
        File popfile = new File("E:/FlightCity/Popfile.csv");
        try {
    ...
    public static ArrayList[][] CountyToCountry() {
        ...
        for (int i = 0; i < IO.Countryname.size(); i++) {
            ...
            //System.out.println(CountyinCountry[i]);
        }
