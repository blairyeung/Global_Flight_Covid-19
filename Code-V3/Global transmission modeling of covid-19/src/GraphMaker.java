...
public class GraphMaker {
    public static void main(String[] args) throws Exception{
        ...
        String part1 = "E:/Global Model/"+date[datenum]+"/Country Death Trail CN-42 ";
        String part2 = ".csv";
        String output1 = "E:/Global Model/"+outdate[datenum]+"/";
        File sumfile = new File("E:/Global Model/Sum/"+"Sum "+outdate[datenum]+".csv");
